...
System.out.println ("teste"); 
	...
	System.out.println ("Vou mostrar o CPF"); 
   ...
   try {  
       ...
       String SQL = "update cliente set NOME = ?, CELULAR = ?, NASCIMENTO = ?, RUA = ?, NUMERO = ?, BAIRRO = ?, CIDADE = ?, `ESTADO` = ?, `PAIS` = ?, CEP = ?, SEXO = ?, EMAIL = ? WHERE cpf = ?";
       ...
       pst.setString(13,Cpf);
       
       pst.executeUpdate();
       pst.clearParameters();
      
       System.out.println("Dados do código "+Cpf+ " alterados com sucesso!");
