...
<title>Apple</title>
            ...
            <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                    <a class="nav-link" href="cadastrousuario.jsp">Cadastra-se</a></li>
                </ul>
    ...
    <body>
        ...
        <div class='box'>
            <a href="apple1.jsp"><img src='imagem/apple2.jpg' height='210' width='170' alt='SERIE 4 CELLULAR' /></a>
            <span>
                <h6>APPLE WATCH SERIE 4 CELLULAR</h6>
                <h4>R$8.280,00</h4>
                <h5>á vista</h5>
        ...
        <div class='box'>
            <a href="apple2.jsp"><img src='imagem/apple3.jpg' height='210' width='170' alt='sERIE 4 CELLULAR' /></a>
            <span>
                <h6>APPLE WATCH SERIE 4 CELLULAR</h6>
                <h4>R$00,00</h4>
                <h5>á vista</h5>
        ...
        <div class='box'>
            <a href="apple3.jsp"><img src='imagem/apple4.jpg' height='210' width='170' alt='Serie 4 cellular' /></a>
            <span>
                <h6>APPLE WATCH SERIE 4 CELLULAR</h6>
                <h4>R$00,00</h4>
                <h5>á vista</h5>
        ...
        <div class='box'>
            <a href="apple4.jsp"><img src='imagem/apple5.jpg' height='210' width='170' alt='Serie 3 nike+' /></a>
            <span>
                <h6>APPLE WATCH SERIE 3 NIKE+</h6>
                <h4>R$00,00</h4>
                <h5>á vista</h5>
                <h5>(Ou em 12x s/ juros.)</h5>
            </span>
        ...
        <div class='box'>
            <a href="apple5.jsp"><img src='imagem/apple6.jpg' height='210' width='170' alt='Serie 3' /></a>
            <span>
                <h6>APPLE WATCH SERIE 3</h6>
                <h4>R$00,00</h4>
                <h5>á vista</h5>
                <h5>(Ou em 12x s/ juros.)</h5>
            </span>
        ...
        <div class='box'>
            <a href="apple6.jsp"><img src='imagem/apple7.jpg' height='210' width='170' alt='Serie 4' /></a>
            <span>
                <h6>APPLE WATCH SERIE 4 CELLULAR</h6>
                <h4>R$00,00</h4>
                <h5>á vista</h5>
