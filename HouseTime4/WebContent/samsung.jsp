...
<body>
    <div class='logotipo'>
        <center><img src="imagem/logosamsung.png" height='65' width='245' alt="Adidas" /></center>
    </div>
    <hr>
    ...
    <div class='box'>
        <img src='imagem/samsung1.jpg' height='200' width='180' alt='Samsung gear s3' />
        <span>
            <h6>SAMSUNG GEAR S3 FRONTIER</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
    ...
    <div class='box'>
        <img src='imagem/samsung2.jpg' height='200' width='180' alt='Samsung gear sport' />
        <span>
            <h6>SAMSUNG GEAR SPORT</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/samsung3.jpg' height='200' width='150' alt='Samsung gear fit 2' />
        <span>
            <h6>SAMSUNG GEAR FIT 2</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/samsung4.jpg' height='200' width='180' alt='Samsung gear s3 classic' />
        <span>
            <h6>SAMSUNG GEAR S3 CLASSIC</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/samsung5.jpg' height='200' width='180' alt='Samsung galaxy watch' />
        <span>
    ...
    <div class='box'>
        <img src='imagem/samsung6.jpg' height='200' width='180' alt='Samsung galaxy watch' />
        <span>
            <h6>SAMSUNG GALAXY WATCH</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
