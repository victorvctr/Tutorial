...
<body>
    <div class='logotipo'>
        <center><img src="imagem/mblogo.png" height='100' width='210' alt="Mont Blanc" /></center>
    </div>
    <hr>
    ...
    <div class='box'>
        <img src='imagem/mont1.jpg' height='210' width='130' alt='Summit 2 preto' />
        <span>
            <h6>SUMMIT 2 PRETO</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
    ...
    <div class='box'>
        <img src='imagem/mont2.jpg' height='210' width='130' alt='Summit 2 aço' />
        <span>
            <h6>SUMMIT 2 AÇO</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
    ...
    <div class='box'>
        <img src='imagem/mont3.jpg' height='210' width='130' alt='Summit 2 Titanium' />
        <span>
            <h6>SUMMIT 2 TITANIUM</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/mont4.jpg' height='210' width='130' alt='Summit 2 aço preto e nylon' />
        <span>
            <h6>SUMMIT 2 AÇO PRETO E NYLON</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/mont5.jpg' height='210' width='130' alt='Summit 2 aço preto Milanese Edition ' />
        <span>
            <h6>SUMMIT 2 AÇO PRETO MILANESE EDITION</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/mont6.jpg' height='210' width='130' alt='Summit 2 aço inoxidável e couro' />
        <span>
            <h6>SUMMIT 2 AÇO INOXIDAVEL E COURO</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
