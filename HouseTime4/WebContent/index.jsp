...
<body>
    ...
    <div class="menu-prod">
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
                <a class="nav-link" href="Prod.jsp?idMarca=1">Apple</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="Prod.jsp?idMarca=2">Samsung</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="Prod.jsp?idMarca=3">Diesel</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="Prod.jsp?idMarca=4">Fossil</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="Prod.jsp?idMarca=5">Mont Blanc</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="Prod.jsp?idMarca=6">Xiaomi</a>
            </li>
        </ul>
    ...
    <div class="container-fluid banner">
        <div class="row">
            <div class="col">
                <a href="Prod.jsp?idMarca=1" title="Conheça nossos produtos Apple!"><img class="d-block w-100" src="imagem/img-apple.png" style="padding-top: 5px;"></a>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="col">
                <a href="Prod.jsp?idMarca=2" title="Conheça nossos produtos Samsung!"><img class="d-block w-100 h-100" src="imagem/img-samsung.png" style="padding-top: 10px;"></a>
            </div>

            <div class="col">
                <a href="Prod.jsp?idMarca=3" title="Conheça nossos produtos Samsung!"><img class="d-block w-100" src="imagem/img-diesel-1.jpg" style="padding-top: 10px;"></a>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="col">
                <a href="Prod.jsp?idMarca=4" title="Conheça nossos produtos Fossil!"><img class="d-block w-50" src="imagem/img-fossil.png" style="margin: auto; padding-top: 10px;"></a>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="col">
                <a href="Prod.jsp?idMarca=5" title="conheça nossos produtos Mont Blanc!"><img class="d-block w-100 h-100" src="imagem/img-mont-blanc.jpg"></a>
            </div>

            <div class="col">
                <a href="Prod.jsp?idMarca=6" title="Conheça nossos produtos Xiaomi!"><img class="d-block w-100" src="imagem/img-xiaomi.png"></a>
            </div>
        </div>
    </div>
<hr>
    ...
    <div class="container text-center text-md-left mt-5">
        ...
        <div class="row mt-3 dark-grey-text">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p>
                    <a class="dark-grey-text" href="Prod.jsp?idMarca=1">Apple</a>
                </p>
                <p>
