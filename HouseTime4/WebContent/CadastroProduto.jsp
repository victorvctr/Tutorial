...
%>
    ...
    try {
        ...
        String SQL = "insert into produto (`SISTEMA`, `PULSEIRA`, `DIMENSAO`, `CAIXA`, `GENERO`, `BATERIA`, `COR`, `PESO`,`MODELO`,`VALOR`, `QUANTIDADE`,`IMAGEM`,`ID_MARCA`) " +
                     "values (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
<body>
  ...
  <hr>
     ...
     <br><br><tr><td><a href="Cadastroproduto1.jsp">Cadastrar novo produto</a></td></tr><br>
