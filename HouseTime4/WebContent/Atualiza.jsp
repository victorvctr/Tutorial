...
<%  
   ...
   try {  
	...
	<form action="AtualizaDados.jsp" method="post">
	
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    Nome Completo:
                    <input type="text"  name="Nome" class="form-control" id="inputnome" placeholder = "<%=rs.getString("nome") %>">
                    
                </div>
                <div class="col-sm">
                    Celular:
                    <input type="text" name="Celular" maxlength="11" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" id="inputcelular" placeholder=" <%=rs.getString("celular") %>">
                </div>
                <div class="col-sm">
                    Data de nascimento:
                    <input type="date" name="Nascimento" class="form-control" placeholder=" <%=rs.getString("nascimento") %>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm">
                    Endereço:
                    <input type="text" name="Rua" class="form-control" placeholder="<%=rs.getString("rua") %>">
                </div>
                <div class="col-sm">
                    N°:
                    <input type="text" name="Numero" maxlength="5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder="<%=rs.getString("numero") %>">
                </div>
                <div class="col-sm">
                    Cidade:
                    <input type="text" name="Cidade" class="form-control" placeholder="<%=rs.getString("cidade") %>">
                </div>
                <div class="col-sm">
                    Estado:
                    <input type="text" name="Estado" class="form-control" placeholder=" <%=rs.getString("estado") %>">
                </div>
                <div class="col-sm">
                    País:
                    <input type="text" name="Pais" class="form-control" placeholder=" <%=rs.getString("pais") %>"></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    CEP:
                    <input type="text" name="Cep" maxlength="8" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder=" <%=rs.getString("cep") %>"></div>

                <div class="col-sm">
                    CPF:
                    <input type="text" name="Cpf" maxlength="11" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder="<%=rs.getString("cpf") %>">
                </div>
                <div class="col-sm">
                    Sexo:
                    <input type="text" name="Sexo" class="form-control" placeholder=" <%=rs.getString("sexo") %>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm">
                    E-mail:
                    <input type="email" name="Email" class="form-control" placeholder=" <%=rs.getString("email") %>" required>
                </div>
