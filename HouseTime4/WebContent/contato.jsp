    ...
    <form>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm">
                    Celular:
                    <input type="text" maxlength="11" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" id="inputcelular" placeholder=" (xx) xxxxx-xxxx">
                </div>
                <div class="col-sm">
                    Data de nascimento:
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    País:
                    <input type="text" class="form-control" placeholder=" Digite seu país"></div>
            </div>

            <div class="row">
                <div class="col-sm">
                    Sexo:
                    <input type="text" class="form-control" placeholder=" Digite seu sexo">
                </div>
            ...
            <div class="row">
                <div class="col-sm">
                    Mensagem:
                    <textarea type="mensagem" class="form-control" placeholder=" Digite aqui sua mensagem" cols="40" rows="10"></textarea>
                </div>
            </div>

            <div class="botao-form">
                <button type="button" class="btn btn-success btn-xl">Enviar</button>
