...
<body>
    <div class='logotipo'>
        <center><img src="imagem/logoxiaomi.png" height='130' width="160" alt="Xiaomi" /></center>
    </div>
    <hr>
    ...
    <div class='box'>
        <img src='imagem/xiaomi1.jpg' height='200' width='180' alt='Xiaomi Amazfit bip A1608' />
        <span>
            <h6>XIAOMI AMAZFIT BIP</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
    ...
    <div class='box'>
        <img src='imagem/xiaomi2.jpg' height='200' width='180' alt='Xiaomi Amazfit Verge GPS' />
        <span>
            <h6>XIAOMI AMAZFIT VERGE GPS</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/xiaomi3.jpg' height='200' width='180' alt="XIAOMI AMAZFIT PACE" />
        <span>
            <h6>XIAOMI AMAZFIT PACE </h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/xiaomi4.jpg' height='200' width='180' alt="Xiaomi Amazfit Verge Global" />
        <span>
            <h6>XIAOMI AMAZFIT VERGE GLOBAL</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/xiaomi5.jpg' height='200' width='180' alt="Mi band 3" />
        <span>
            <h6>XIAOMI MI BAND 3</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/xiaomi6.jpg' height='200' width='180' alt=" XIAOMI AMAZFIT BIP A1608" />
        <span>
            <h6> XIAOMI AMAZFIT BIP A1608</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
