    ...
    <form>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    N°:
                    <input type="text" name="Numero" maxlength="5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder="N° da residência">
                </div>
                <div class="col-sm">
                    Cidade:
                ...
                <div class="col-sm">
                    País:
                    <input type="text" name="Pais" class="form-control" placeholder=" Digite seu país"></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    CPF:
                    <input type="text" name="Cpf" maxlength="11" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder="Digite seu CPF sem pontuação">
                </div>
                <div class="col-sm">
                    Sexo:
    ...
    <div class="container text-center text-md-left mt-5">
        ...
        <div class="row mt-3 dark-grey-text">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                    <a class="dark-grey-text" href="login.html">Área do Cliente</a>
                </p>
