...
<body>
    <div class="logotipo">
        <center><img src="imagem/logodiesel.png" height="50" width="240" alt="Diesel" /></center>
    </div>
    <hr>
    ...
    <div class="box">
        <img src="imagem/diesel1.jpg" height="190" width="125" alt="Diesel Smartwatch Dzt2002" />
        <span>
            <h6>DIESEL SMARTWATCH DZT2002 </h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
    ...
    <div class='box'>
        <img src='imagem/diesel2.jpg' height='190' width='125' alt='Diesel Smartwatch Dzt2005 ' />
        <span>
            <h6>DIESEL SMARTWATCH DZT2005</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/diesel3.jpg' height='190' width='130' alt='Diesel Hybrido - Dzt1000' />
        <span>
            <h6>DIESEL HYBRIDO DZT1000 </h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/diesel4.jpg' height='190' width='130' alt='Diesel On DZT2011 Full Guard 2.5' />
        <span>
            <h6>DIESEL ON DZT2011 FULL GUARD</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
    ...
    <div class='box'>
        <img src='imagem/diesel5.jpg' height='190' width='130' alt='Diesel On DZT2010 Full Guard 2.5 ' />
        <span>
            <h6>DIESEL ON DZT2011 FULL GUARD</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
    ...
    <div class='box'>
        <img src='imagem/diesel6.jpg' height='190' width='130' alt='Diesel On Híbrido' />
        <span>
            <h6>DIESEL ON HIBRIDO</h6>
            <h4>R$00,00</h4>
            <h5>á vista</h5>
            <h5>(Ou em 12x s/ juros.)</h5>
        </span>
